...
import { FiHome, FiUser, FiMenu, FiX, FiActivity, FiSearch, FiChevronDown, FiLogIn } from 'react-icons/fi';
      ...
      {mobileMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white shadow-lg">
            ...
            <Link href="#" className="block px-3 py-2 rounded-md text-base font-medium text-indigo-600 hover:text-indigo-700 hover:bg-neutral-50">
