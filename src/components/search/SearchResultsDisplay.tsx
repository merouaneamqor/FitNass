...
import { FiSearch, FiMapPin, FiStar, FiAlertCircle, FiFilter, FiX, FiCpu, FiGrid, FiList, FiUsers, FiCalendar } from 'react-icons/fi';
          ...
          <main className="md:col-span-3">
            ...
            {isPending && (
              <div className="flex justify-center items-center py-12">
                <div className="w-12 h-12 border-4 border-yellow-500 dark:border-red-600 border-t-transparent dark:border-t-transparent rounded-full animate-spin"></div>
              </div>
            )}
