...
export default function MobileAppSection({ appImageUrl }: MobileAppSectionProps) {
  ...
  return (
    <section className="py-16 md:py-24 bg-jet-black overflow-hidden border-t border-b border-neutral-800">
      <div className="max-w-7xl mx-auto px-6">
        <div className="relative rounded-lg bg-gunmetal-gray border border-neutral-700/80 overflow-hidden shadow-xl">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button className="inline-flex items-center justify-center bg-jet-black hover:bg-neutral-800 text-white py-3 px-6 rounded-md transition-colors duration-200 font-semibold border border-neutral-700 hover:border-neon-yellow group">
                    <FaApple className="h-5 w-5 mr-3 text-neutral-400 group-hover:text-white transition-colors" />
                  ...
                  <button className="inline-flex items-center justify-center bg-jet-black hover:bg-neutral-800 text-white py-3 px-6 rounded-md transition-colors duration-200 font-semibold border border-neutral-700 hover:border-neon-yellow group">
                    <FaGooglePlay className="h-5 w-5 mr-3 text-neutral-400 group-hover:text-white transition-colors" />
                    <div className="text-left font-poppins">
